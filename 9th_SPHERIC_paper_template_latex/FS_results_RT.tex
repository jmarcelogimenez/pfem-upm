...
Presentacría tabla o gráfico con estos resultados de este último parrafo ??
...
If the conclusions about the 2D case were extended to this simulation, the solution could be improved using shorter time-steps.No lo entiendo ??
