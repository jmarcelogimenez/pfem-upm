...
Finally, the last example is a direct comparison against results coming from a dam-break experimnent.
...
Previous PFEM-2 versions showed that the computational cost of each time-step is almost equal than traditional Eulerian solvers (see \cite{Idelsohn12b}\cite{Gimenez14}). In this new version the possibility of increasing the time step, decreases the duration of the global computation without any loss of accuracy.
